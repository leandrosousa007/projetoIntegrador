 ...
 * @author leand
 */
public class PenalidadeControle {
    
    public static void main(String[] args) {
       /* PenalidadeControle teste = new PenalidadeControle();
        Penalidade ins = new Penalidade();
        ins.setNome("Leozin");
        ...
        String res = teste.inserirPenalidade(ins);
        System.out.println("Retorno: " + res);*/
        

        
       /* String res = teste.removerPenalidade(5); //Remover Penalidade
    ...
    try (Connection conn = conexao.conectar();
        ...
        Logger.getLogger(PenalidadeControle.class.getName()).log(Level.SEVERE, null, ex);
    }
    return penalidade;
}
