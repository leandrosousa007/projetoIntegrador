...
<head>
    ...
    <title>Inserir Responsável</title>
    ...
    <div class="container mt-5">
        ...
        <div class="container-box">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2>Inserir Responsável</h2>
                    <!-- Usando o form:form do Spring -->
                    <form:form method="POST" action="${pageContext.request.contextPath}/inserirResponsavel" modelAttribute="responsavel">
                        
                        <div class="mb-3">
                            <form:label path="nome_resp" class="form-label">Nome do Responsável</form:label>
                            <form:input path="nome_resp" type="text" class="form-control" required="required"/>
                        </div>
                ...
                <!-- Container à direita com o mesmo tamanho da div do formulário -->
                <div class="col-md-6">
