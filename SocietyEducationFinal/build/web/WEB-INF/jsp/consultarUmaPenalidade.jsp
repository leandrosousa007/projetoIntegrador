...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Consultar Penalidades</h2>
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/consultarUmaPenalidade" modelAttribute="penalidade" name="formulario" id="formulario"> 
                        <form:errors path = "*" cssClass = "blocoerro" element = "div" />
                        <div class="mb-3">
                             <form:label path="cod_penalidade" class="form-label">Penalidade</form:label>
                             
                                <form:select path="cod_penalidade" class="form-select">
                                   <form:option value="0" label="Selecionar"/>
                                    <form:options items="${webConsultarPenalidades}" />
                                </form:select>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        <h3>Informações da Penalidade</h3>
                        
                        <div class="mb-3">
                            <form:label path="cod_penalidade" class="form-label">Código da Penalidade</form:label>
                            <p class="info-paragraph">${cod_penalidade}</p>
                        </div>

                        <div class="mb-3">
                            <form:label path="tipo" class="form-label">Tipo da Penalidade</form:label>
                            <p class="info-paragraph">${tipo}</p>
                        </div>

                        <div class="mb-3">
                            <form:label path="data_inicio" class="form-label">Data Inicio</form:label>
                            <p class="info-paragraph">${data_inicio}</p>
                        </div>
