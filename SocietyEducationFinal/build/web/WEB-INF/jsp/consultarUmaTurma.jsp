        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/consultarTurma" modelAttribute="turma" name="formulario" id="formulario"> 
                        <form:errors path = "*" cssClass = "blocoerro" element = "div" />
                        <div class="mb-3">
                             <form:label path="cod_turma" class="form-label">Turma</form:label>
                             
                                <form:select path="cod_turma" class="form-select">
                ...
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        ...
                        <div class="mb-3">
                            <form:label path="cod_turma" class="form-label">Código da Turma</form:label>
                            <p class="info-paragraph">${cod_turma}</p>
                        </div>

                        <div class="mb-3">
                            <form:label path="nome_turma" class="form-label">Nome da Turma</form:label>
                            <p class="info-paragraph">${nome_turma}</p>
                        </div>

                        <div class="mb-3">
                            <form:label path="ano" class="form-label">Ano</form:label>
                            <p class="info-paragraph">${ano}</p>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="periodo" class="form-label">Periodo</form:label>
                            <p class="info-paragraph">${periodo}</p>
                        </div>
