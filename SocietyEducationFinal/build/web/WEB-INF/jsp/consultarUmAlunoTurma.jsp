...
<head>
    ...
    <title>Consultar AlunoTurma</title>
...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Consultar AlunoTurma</h2>
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/consultarUmAlunoTurma" modelAttribute="alunoturma" name="formulario" id="formulario">
                        <form:errors path = "*" cssClass = "blocoerro" element = "div" />
                        <div class="mb-3">
                             <form:label path="cod_aluno_turma" class="form-label">AlunoTurma</form:label>
                             
                                <form:select path="cod_aluno_turma" class="form-select">
                                   <form:option value="0" label="Selecionar"/>
                                    <form:options items="${webConsultarAlunosTurmas}" />
                                </form:select>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        <h3>Informações do Aluno-Turma</h3>
                        
                        <div class="mb-3">
                            <form:label path="cod_aluno_turma" class="form-label">Código do Aluno-Turma</form:label>
                            <p class="info-paragraph">${cod_aluno_turma}</p>
                        </div>

                        <div class="mb-3">
                            <form:label path="data_matricula" class="form-label">Data da Matricula</form:label>
                            <p class="info-paragraph">${data_matricula}</p>
                        </div>
                        ...
                        <div class="mb-3">
                            <form:label path="cod_turma" class="form-label">Turma</form:label>
                            <p class="info-paragraph">${cod_turma}</p>
                        </div>
                </div>
                </div>
                    </form:form>
