...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Alterar Penalidade</h2>
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/alterarPenalidade" modelAttribute="penalidade" id="formAlterarCurso">
                        

                        <div class="mb-3">
                                <form:select path="tipo" class="form-select">
                                   <form:option value="0" label="Selecionar"/>
                                    <form:options items="${webConsultarTipoPenalidade}" />
                                </form:select>
                        </div>

                        <div class="mb-3">
                            <form:label path="data_inicio" class="form-label">Data Inicio</form:label>
                            <form:input path="data_inicio" type="date" class="form-control" required="required" />
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="qnt_dias" class="form-label">Quantidade de Dias</form:label>
                            <form:input path="qnt_dias" type="number" class="form-control" required="required" />
                        </div>
