        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form:form method="POST" action="${pageContext.request.contextPath}/alterarResponsavel" modelAttribute="responsavel">
                        <div class="mb-3">
                            <form:label path="nome_resp" class="form-label">Nome do Responsável</form:label>
                            <form:input path="nome_resp" class="form-control" required="required" />
                        </div>
                ...
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        ...
                        <br>
                                ...
                                <form:select path="cod_resp" class="form-select">
