...
<head>
    ...
    <title>Consultar Responsável</title>
        ...
        <div class="container-box">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/consultarResponsavel" modelAttribute="responsavel">
                    <form:errors path = "*" cssClass = "blocoerro" element = "div" />

                        <div class="mb-3">
                            <form:select path="cod_resp" class="form-select" required="required"><br>
                                <form:option value="0">Selecionar Responsável</form:option>
                                <form:options items="${webConsultarResponsaveis}" />
                            </form:select>
                        </div>

                        <input type="submit" class="btn btn-primary" value="Buscar Responsável"/>
                    
                </div>

                <!-- Container à direita com informações do responsável -->
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        <h3>Informações do Responsável</h3>
                        <div class="mb-3">
                            <form:label path="cod_resp" class="form-label">Código do Responsável</form:label>
                            <p class="info-paragraph">${cod_resp}</p>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="nome_resp" class="form-label">Nome do Responsável</form:label>
                            <p class="info-paragraph">${nome_resp}</p>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <p class="info-paragraph">${email}</p>
                        </div>
