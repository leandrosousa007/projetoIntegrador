        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/alterarFuncionario" modelAttribute="funcionario" id="formAlterarFuncionario">
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="cargo" type="text" class="form-control" required="required" />
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="senha" type="password" class="form-control" required="required" />
                        </div>
