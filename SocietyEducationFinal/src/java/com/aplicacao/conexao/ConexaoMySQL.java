...
public class ConexaoMySQL {
    ...
    public Connection conectar() {
        ...
        try {
            ...
            String bd = "se"; // nome do banco de dados
            String pw = "root"; // Senha do usuario, so tirar o root que vai dar certo ou colocar a senha que foi definida!
