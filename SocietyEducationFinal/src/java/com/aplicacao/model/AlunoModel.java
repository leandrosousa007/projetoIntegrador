...
public class AlunoModel {
    ...
    public String inserirAluno(Aluno aluno) {//certo
        ...
        if (aluno.getNome() != null && !aluno.getNome().isEmpty() &&
            ...
            aluno.getEndereco() != null && !aluno.getEndereco().isEmpty() &&
            aluno.getData_nasc() != null && 
            aluno.getRg() != null && !aluno.getRg().isEmpty() &&
            aluno.getMatricula() != null && !aluno.getMatricula().isEmpty() ){
            String consulta ="INSERT INTO Aluno (nome,email,telefone,endereco,data_nasc,rg,matricula,sexo,cod_resp,cod_curso) VALUES (?,?,?,?,?,?,?,?,?,?)";
            ...
            stm.setObject(5, aluno.getData_nasc());
            stm.setString(6, aluno.getRg()+"");
            stm.setString(7, aluno.getMatricula());
            stm.setString(8, aluno.getSexo()+"");
            stm.setInt(9, aluno.getCod_resp());
            stm.setInt(10, aluno.getCod_curso());
