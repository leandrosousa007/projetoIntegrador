...
<head>
    ...
    <title>Remover AlunoTurma</title>
...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Remover AlunoTurma</h2>
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/removerAlunoTurma" modelAttribute="alunoturma">
                        <div class="mb-3">
