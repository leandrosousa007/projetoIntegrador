...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Alterar Ocorrência</h2>
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/alterarOcorrencia" modelAttribute="ocorrencia" id="formulario">
                        

                        <div class="mb-3">
                            <form:label path="campus" class="form-label">Campus</form:label>
                            <form:input  path="campus" type="text" class="form-control" id="nc" required="required"/>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="descricao_ocorrencia" class="form-label">Descrição da Ocorrência</form:label>
                            <form:input  path="descricao_ocorrencia" type="text" class="form-control" id="nc" required="required"/>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="data_registro_ocorrencia" class="form-label">Data do registro da ocorrência</form:label>
                            <form:input  path="data_registro_ocorrencia" type="date"  class="form-control" id="sg" required="required"/>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="data_acontecimento" class="form-label">Data do acontecimento</form:label>
                            <form:input  path="data_acontecimento" type="date"  class="form-control" id="sg" required="required"/>
                        </div>
                        
                     
                        <div class="mb-3">
                            <form:label path="resolucao" class="form-label">Resolução</form:label>
                            <form:input  path="resolucao" type="text" class="form-control" id="nc" required="required"/>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="cod_aluno" class="form-label">Aluno</form:label>
                            <form:select path="cod_aluno" class="form-select" required="required">
                                <option value="0">Selecionar Aluno</option>
                                <form:options items="${webConsultarAlunos}" />
                            </form:select>
                        </div>
                            
                        <div class="mb-3">
                            <form:label path="cod_funcionario" class="form-label">Funcionário</form:label>
                            <form:select path="cod_funcionario" class="form-select" required="required">
                                <option value="0">Selecionar Responsável</option>
                                <form:options items="${webConsultarFuncionarios}" />
                            </form:select>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        <h3>Selecione a Ocorrência</h3>
                        <br>
                             
                                <form:select path="cod_ocorrencia" class="form-select">
                                   <form:option value="0" label="Selecionar"/>
                                    <form:options items="${webConsultarOcorrencias}" />
                                </form:select>
                        <br>
