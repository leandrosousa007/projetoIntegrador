        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/consultarCurso" modelAttribute="curso" name="formulario" id="formulario"> 
