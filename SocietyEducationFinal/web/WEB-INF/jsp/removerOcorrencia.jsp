...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Remover Ocorrência</h2>
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/removerOcorrencia" modelAttribute="ocorrencia">
                        <div class="mb-3">
                            <form:label path="cod_ocorrencia" class="form-label">Ocorrências</form:label>
