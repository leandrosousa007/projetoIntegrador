    ...
    <div class="container mt-5">
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Inserir Curso</h2>
                    <form:form method="POST" action="${pageContext.request.contextPath}/inserirCurso" commandName="curso" id="formulario">
                        <div class="mb-3">
                            <form:label path="nome_curso" class="form-label">Nome do Curso</form:label>
                            <form:input  path="nome_curso" type="text" class="form-control" id="nc" required="required"/>
                        </div>

                        <div class="mb-3">
                            <form:label path="sigla" class="form-label">Sigla</form:label>
                            <form:input  path="sigla" type="text"  class="form-control" id="sg" required="required"/>
                        </div>
