...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        ...
        <!-- Container com bordas e profundidade -->
        <div class="container-box">
            <div class="row">
                <!-- Formulário de inserção de aluno à esquerda -->
                <div class="col-md-6">
                    <h2>Inserir Aluno</h2>
                    <!-- Formulário Spring -->
                    <form:form method="POST" action="${pageContext.request.contextPath}/inserirAluno" modelAttribute="aluno" id="formulario">
                ...
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        <center><h3>Society Education</h3>
                        <p>${resultado}</p></center>
                    </div>
                </div>
            </div>
        </div>
