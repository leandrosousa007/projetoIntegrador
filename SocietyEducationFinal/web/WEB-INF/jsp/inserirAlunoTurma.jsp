...
<head>
    ...
    <title>Inserir AlunoTurma</title>
    ...
    <div class="container mt-5">
        ...
        <div class="container-box">
            <div class="row">
                ...
                <div class="col-md-6">
                    <h2>Inserir AlunoTurma</h2>
                    <!-- Formulário Spring -->
                    <form:form method="POST" action="${pageContext.request.contextPath}/inserirAlunoTurma" modelAttribute="alunoturma" id="formulario">
                        
                        <div class="mb-3">
                            <form:label path="data_matricula" class="form-label">Data Matricula</form:label>
                            <form:input path="data_matricula" type="date" class="form-control" required="required" />
                        </div>

                        
                        <div class="mb-3">
                            <form:label path="cod_turma" class="form-label">Turma</form:label>
                            <form:select path="cod_turma" class="form-select" required="required">
                                <option value="0">Selecionar turma</option>
                                <form:options items="${webConsultarTurmas}" />
                            </form:select>
                        </div>
