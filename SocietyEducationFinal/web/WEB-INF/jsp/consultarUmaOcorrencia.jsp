        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/consultarUmaOcorrencia" modelAttribute="ocorrencia" name="formulario" id="formulario"> 
                        <form:errors path = "*" cssClass = "blocoerro" element = "div" />
                        <div class="mb-3">
                             <form:label path="cod_ocorrencia" class="form-label">Ocorências</form:label>
                ...
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        ...
                        <div class="mb-3">
                            <form:label path="cod_ocorrencia" class="form-label">Código da Ocorrência</form:label>
                            <p class="info-paragraph">${cod_ocorrencia}</p>
                        </div>

                        <div class="mb-3">
                            <form:label path="campus" class="form-label">Campus</form:label>
                            <p class="info-paragraph">${campus}</p>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="descricao_ocorrencia" class="form-label">Descrição da Ocorrência</form:label>
                            <p class="info-paragraph">${descricao_ocorrencia}</p>
                        </div>

                        <div class="mb-3">
                            <form:label path="data_registro_ocorrencia" class="form-label">Data do registro da Ocorrência</form:label>
                            <p class="info-paragraph">${data_registro_ocorrencia}</p>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="data_acontecimento" class="form-label">Data do Acontecimento</form:label>
                            <p class="info-paragraph">${data_acontecimento}</p>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="resolucao" class="form-label">Resolução</form:label>
                            <p class="info-paragraph">${resolucao}</p>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="cod_aluno" class="form-label">Código do Aluno</form:label>
                            <p class="info-paragraph">${cod_aluno}</p>
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="cod_funcionario" class="form-label">Código do Funcionario</form:label>
                            <p class="info-paragraph">${cod_funcionario}</p>
                        </div>
