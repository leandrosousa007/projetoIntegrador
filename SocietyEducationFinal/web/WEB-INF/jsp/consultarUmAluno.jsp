        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/consultarAluno" modelAttribute="aluno" name="formulario" id="formulario">
                        <form:errors path = "*" cssClass = "blocoerro" element = "div" />
                        <div class="mb-3">
                             <form:label path="cod_aluno" class="form-label">Aluno</form:label>
                             
                                <form:select path="cod_aluno" class="form-select">
