...
<head>
    ...
    <title>Alterar AlunoTurma</title>
    ...
    <div class="container mt-5">
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Alterar Curso</h2>
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/alterarAlunoTurma" modelAttribute="alunoturma" id="formAlterarAlunoTurma">
