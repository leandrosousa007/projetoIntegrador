...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        ...
        <div class="container-box">
            <div class="row">
                <!-- Formulário de inserção de turma à esquerda -->
                <div class="col-md-6">
                    <h2>Inserir Turma</h2>
                    <!-- Formulário Spring -->
                    <form:form method="POST" action="${pageContext.request.contextPath}/inserirTurma" modelAttribute="turma" id="formulario">
                        
                        <div class="mb-3">
                            <form:label path="nome_turma" class="form-label">Nome</form:label>
                            <form:input path="nome_turma" type="text" class="form-control" required="required" />
                        </div>
                    
                        
                        <div class="mb-3">
                            <form:label path="ano" class="form-label">Ano</form:label>
                            <form:input path="ano" type="number" class="form-control" required="required" />
                        </div>
                        
                        <div class="mb-3">
                            <form:label path="periodo" class="form-label">Periodo</form:label>
                            <form:input path="periodo" type="text" class="form-control" required="required" />
                        </div>
