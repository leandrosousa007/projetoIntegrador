    ...
    <div class="container-scroller">
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  ...
                  <a class="dropdown-item" href="painelnew"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
              </div>
            </li>
          </ul>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link" href="painelnew">
    ...
    <div class="container mt-5">
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Alterar Aluno</h2>
                    <form:form method="POST" action="${pageContext.request.contextPath}/alterarAluno" modelAttribute="aluno" id="formulario">
                        ...
                        <div class="mb-3">
                            ...
                            <form:input path="telefone" type="tel" class="form-control" required="required" />
                        </div>

                        <div class="mb-3">
                            <form:label path="endereco" class="form-label">Endereço</form:label>
                            <form:input path="endereco" type="text" class="form-control" required="required" />
                        </div>

                        <div class="mb-3">
                            <form:label path="data_nasc" class="form-label">Data de Nascimento</form:label>
                            <form:input path="data_nasc" type="date" class="form-control" required="required" />
                        </div>

                        <div class="mb-3">
                            <form:label path="rg" class="form-label">RG</form:label>
                            <form:input path="rg" type="text" class="form-control" required="required" />
                        </div>

                        <div class="mb-3">
                            <form:label path="matricula" class="form-label">Matrícula</form:label>
                            <form:input path="matricula" type="text" class="form-control" required="required" />
                        </div>

                        <div class="mb-3">
                            <form:label path="sexo" class="form-label">Sexo</form:label>
                            <form:select path="sexo" class="form-select" required="required">
                                <option value="">Selecionar</option>
                                <form:options items="${sexoEscolha}" />
                            </form:select>
                        </div>

                        <div class="mb-3">
                            <form:label path="cod_resp" class="form-label">Responsável</form:label>
                            <form:select path="cod_resp" class="form-select" required="required">
                                <option value="0">Selecionar Responsável</option>
                                <form:options items="${webConsultarResponsaveis}" />
                            </form:select>
                        </div>

                        <div class="mb-3">
                            <form:label path="cod_curso" class="form-label">Curso</form:label>
                            <form:select path="cod_curso" class="form-select" required="required">
