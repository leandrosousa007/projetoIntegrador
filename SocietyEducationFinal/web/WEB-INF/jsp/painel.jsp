                        ...
                        <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                                <div class="dropdown-header text-center">
                                    ...
                                    <p class="mb-1 mt-3 fw-semibold">${nome}</p>
                                    <p class="fw-light text-muted mb-0">${nome}@gmail.com</p>
                                </div>
            ...
            <li class="nav-item"> <a class="nav-link" href="inserirAlunoTurma">Inserir Aluno-Turma</a></li>
                                                ...
                                                <div class="home-tab">
                                                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link active ps-0" id="home-tab" data-bs-toggle="tab" href="#overview" role="tab" aria-controls="overview" aria-selected="true">Principal</a>
                                                            </li>
                            ...
                            <footer class="footer">
                                <div class="d-sm-flex justify-content-center justify-content-sm-between">
                                    ...
                                    <span class="float-none float-sm-end d-block mt-1 mt-sm-0 text-center">Copyright © 2024. Todos os direitos reservados SocietyEducation.</span>
                                </div>
                            </footer>
                            <!-- partial -->
                            </div>
