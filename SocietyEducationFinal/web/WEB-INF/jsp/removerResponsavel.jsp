...
<script src="${pageContext.request.contextPath}/resourcesPainel/assets//vendors/js/vendor.bundle.base.js"></script>
    ...
    <div class="container mt-5">
        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    <h2>Remover Responsavel</h2>
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/removerResponsavel" modelAttribute="responsavel">
                        <div class="mb-3">
                            <form:label path="cod_resp" class="form-label">Responsavel</form:label>
