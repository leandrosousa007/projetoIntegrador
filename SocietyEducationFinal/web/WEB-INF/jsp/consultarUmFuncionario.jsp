        ...
        <div class="container-box">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form:form method="POST" onsubmit="${pageContext.request.contextPath}/consultarFuncionario" modelAttribute="funcionario" name="formulario" id="formulario"> 
                        <form:errors path = "*" cssClass = "blocoerro" element = "div" />
                        <div class="mb-3">
                             <form:label path="cod_funcionario" class="form-label">Funcionario</form:label>
                             
                                <form:select path="cod_funcionario" class="form-select">
                ...
                <div class="col-md-6">
                    <div class="border p-4 h-100 conr">
                        <h3>Informações do Funcionario</h3>
